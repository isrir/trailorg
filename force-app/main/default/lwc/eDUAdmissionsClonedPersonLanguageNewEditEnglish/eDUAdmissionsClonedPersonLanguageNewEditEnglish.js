...
import { OMNIDEF } from './eDUAdmissionsClonedPersonLanguageNewEditEnglish_def.js';
import tmpl from './eDUAdmissionsClonedPersonLanguageNewEditEnglish.html';
import tmpl_nds from './eDUAdmissionsClonedPersonLanguageNewEditEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eDUAdmissionsClonedPersonLanguageNewEditEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
