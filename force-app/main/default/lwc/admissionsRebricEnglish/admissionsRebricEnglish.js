...
import { OMNIDEF } from './admissionsRebricEnglish_def.js';
import tmpl from './admissionsRebricEnglish.html';
import tmpl_nds from './admissionsRebricEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class admissionsRebricEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
