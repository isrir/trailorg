...
import { OMNIDEF } from './eDUAdmissionsClonedNewFileSectionEnglish_def.js';
import tmpl from './eDUAdmissionsClonedNewFileSectionEnglish.html';
import tmpl_nds from './eDUAdmissionsClonedNewFileSectionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eDUAdmissionsClonedNewFileSectionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
