...
import { OMNIDEF } from './eDUAdmissionsClonedNewEditSiblingEnglish_def.js';
import tmpl from './eDUAdmissionsClonedNewEditSiblingEnglish.html';
import tmpl_nds from './eDUAdmissionsClonedNewEditSiblingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eDUAdmissionsClonedNewEditSiblingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
