...
import { OMNIDEF } from './eDUAdmissionsClonedNewEditGuardianEnglish_def.js';
import tmpl from './eDUAdmissionsClonedNewEditGuardianEnglish.html';
import tmpl_nds from './eDUAdmissionsClonedNewEditGuardianEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eDUAdmissionsClonedNewEditGuardianEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
