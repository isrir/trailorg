...
import { OMNIDEF } from './pulsecheckWeeklyVibeCheckEnglish_def.js';
import tmpl from './pulsecheckWeeklyVibeCheckEnglish.html';
import tmpl_nds from './pulsecheckWeeklyVibeCheckEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pulsecheckWeeklyVibeCheckEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
