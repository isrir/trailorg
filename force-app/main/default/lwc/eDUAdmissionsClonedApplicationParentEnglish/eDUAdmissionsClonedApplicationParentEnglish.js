...
import { OMNIDEF } from './eDUAdmissionsClonedApplicationParentEnglish_def.js';
import tmpl from './eDUAdmissionsClonedApplicationParentEnglish.html';
import tmpl_nds from './eDUAdmissionsClonedApplicationParentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eDUAdmissionsClonedApplicationParentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
