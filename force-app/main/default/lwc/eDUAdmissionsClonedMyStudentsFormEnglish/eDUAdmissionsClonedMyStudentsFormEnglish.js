...
import { OMNIDEF } from './eDUAdmissionsClonedMyStudentsFormEnglish_def.js';
import tmpl from './eDUAdmissionsClonedMyStudentsFormEnglish.html';
import tmpl_nds from './eDUAdmissionsClonedMyStudentsFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eDUAdmissionsClonedMyStudentsFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
