...
import { OMNIDEF } from './eDUAdmissionsClonedPersonEducationNewEditEnglish_def.js';
import tmpl from './eDUAdmissionsClonedPersonEducationNewEditEnglish.html';
import tmpl_nds from './eDUAdmissionsClonedPersonEducationNewEditEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eDUAdmissionsClonedPersonEducationNewEditEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
