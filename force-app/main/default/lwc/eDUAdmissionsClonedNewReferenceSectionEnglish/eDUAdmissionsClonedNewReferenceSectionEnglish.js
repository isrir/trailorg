...
import { OMNIDEF } from './eDUAdmissionsClonedNewReferenceSectionEnglish_def.js';
import tmpl from './eDUAdmissionsClonedNewReferenceSectionEnglish.html';
import tmpl_nds from './eDUAdmissionsClonedNewReferenceSectionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eDUAdmissionsClonedNewReferenceSectionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
