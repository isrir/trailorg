...
import { OMNIDEF } from './eDUAdmissionsClonedNewEditFileFormEnglish_def.js';
import tmpl from './eDUAdmissionsClonedNewEditFileFormEnglish.html';
import tmpl_nds from './eDUAdmissionsClonedNewEditFileFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eDUAdmissionsClonedNewEditFileFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
