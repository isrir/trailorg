...
import { OMNIDEF } from './eDUAdmissionsClonedNewReferenceSectionWrapperEnglish_def.js';
import tmpl from './eDUAdmissionsClonedNewReferenceSectionWrapperEnglish.html';
import tmpl_nds from './eDUAdmissionsClonedNewReferenceSectionWrapperEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eDUAdmissionsClonedNewReferenceSectionWrapperEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
