...
import { OMNIDEF } from './eDUAdmissionsClonedRequestRecommenderEnglish_def.js';
import tmpl from './eDUAdmissionsClonedRequestRecommenderEnglish.html';
import tmpl_nds from './eDUAdmissionsClonedRequestRecommenderEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eDUAdmissionsClonedRequestRecommenderEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
