...
import { OMNIDEF } from './eDUAdmissionsClonedNewPersonAccountEnglish_def.js';
import tmpl from './eDUAdmissionsClonedNewPersonAccountEnglish.html';
import tmpl_nds from './eDUAdmissionsClonedNewPersonAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eDUAdmissionsClonedNewPersonAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
